...
Source:
[`DESCRIPTION`](https://github.com/cttir/cellreportR/blob/main/DESCRIPTION)

Heller R (2026). *cellreportR: Cell Culture Microscopy Assay Analysis
and Reporting*. R package version 0.1.0,
